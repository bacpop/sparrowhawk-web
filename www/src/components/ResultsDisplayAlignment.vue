<template>
  <svg v-if="hasAlignmentData" id="tree_container" class="w-full"></svg>
</template>
...
export default defineComponent({
  ...
  computed: {
    hasAlignmentData(): boolean {
      return this.allResults_ska.alignResults[0]?.aligned === true ||
             this.allResults_ska.alignResults[0]?.aligned === false;
    }
  },
